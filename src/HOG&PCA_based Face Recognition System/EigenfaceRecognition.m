function Recognized_index = EigenfaceRecognition(TestImage, m, A, Eigenfaces)
% 识别步骤...
%
...
[features, ~] = extractHOGFeatures(TestImage, 'CellSize', cellSize, ...
            'BlockSize', blockSize, 'BlockOverlap', blockOverlap, 'NumBins', numBins);


Difference = double(features') - m; % 居中的测试图像
